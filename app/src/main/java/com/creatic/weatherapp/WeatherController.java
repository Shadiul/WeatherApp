package com.creatic.weatherapp;
...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "d80779f157128f983c9e0a7dca8bd97c";
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d("App", "longitude is: " + longitude);
                Log.d("App", "latitude is: " + latitude);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Log.d("WeatherApp", "onRequestPermissionsResult(): Permission granter!");
                getWeatherForCurrentLocation();
            } else {
    ...
    private void letsDoSomeNetworking(RequestParams params) {
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d("App", "Success! JSON: " + response.toString());

                WeatherDataModel weatherDataModel = WeatherDataModel.fromJson(response);
                Log.d("App", "Location: " + weatherDataModel.getmCity());
                Log.d("App", "Temperature: " + weatherDataModel.getmTemperature());
                Log.d("App", "IconName: " + weatherDataModel.getmIconName());
                updateUI(weatherDataModel);
            }

            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Log.e("App", "Fail " + throwable.toString());
